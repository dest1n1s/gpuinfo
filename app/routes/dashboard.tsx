import { MultiPartitionsSelector } from "@/components/app/multi-partitions-selector";
...
export default function Page() {
  ...
  return (
    <div className="flex min-h-screen flex-col w-full pt-10 pb-20 gap-10">
      ...
      {partitions.map(
        partition =>
          (selectedPartitions.includes(partition.partition) || selectedPartitions.length === 0) && (
